            ...
            <div className="relative">
              ...
              >
                {product.images.length > 0 ? (
                  <img src={product.images[activeImage]} alt={product.title} className="w-full h-full object-cover" loading="lazy" onError={(e: any) => { e.target.src = '/placeholder.png' }} />
                ) : (
            ...
            {product.images.length > 1 && (
              <div className="flex gap-2 mt-3">
                {product.images.map((img, i) => (
                  ...
                  >
                    <img src={img} alt="" className="w-full h-full object-cover" loading="lazy" onError={(e: any) => { e.target.src = '/placeholder.png' }} />
                  </button>
                ))}
              </div>
            )}
            ...
            {related.map(r => (
              <Link key={r.id} href={'/products/' + r.id} className="bg-white rounded-xl overflow-hidden hover:shadow-md transition-shadow">
                <div className="bg-gray-100 h-32 w-full flex items-center justify-center">
                  {r.images.length > 0 ? (
                    <img src={r.images[0]} alt={r.title} className="w-full h-full object-cover" loading="lazy" onError={(e: any) => { e.target.src = '/placeholder.png' }} />
                  ) : (
