...
import { MapPin, Package, LogOut, Edit, Check, X } from 'lucide-react'
      ...
      <div className="max-w-4xl mx-auto px-4 py-8">
        ...
        {loading ? (
          ...
          <div className="text-center py-16 bg-white rounded-2xl">
            ...
            <Link href="/products/new" className="bg-orange-500 text-white px-6 py-3 rounded-xl font-medium hover:bg-orange-600 transition-colors">
            ...
            {products.map((product) => (
              <div key={product.id} className="bg-white rounded-2xl overflow-hidden shadow-sm">
                <Link href={'/products/' + product.id}>
                  <div className="bg-gray-100 h-40 w-full flex items-center justify-center relative">
